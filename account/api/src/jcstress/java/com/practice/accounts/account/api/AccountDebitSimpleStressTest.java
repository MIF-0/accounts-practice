...
In this test we are expecting only TOO_MANY_OPERATIONS error due to optimistic locking.
* **/
@JCStressTest
...
@Outcome(id = "500, 200, 2", expect = ACCEPTABLE, desc = "One update lost.")
@Outcome(id = "200, 500, 1", expect = ACCEPTABLE, desc = "One update lost.")
@Outcome(id = "200, 200, 3", expect = ACCEPTABLE, desc = "Both updates.")
@State
public class AccountDebitSimpleStressTest implements AccountFactory, MoneyFactory {
